...
with(this){return _c('p',[_v("Classes used by multiple components are in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("seedu.recruittrackpro.commons")]),_v(" package.")])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"add-tags-feature"}},[_v("Add Tags feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#add-tags-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Given below is the activity diagram of a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddTagsCommand")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"remove-tags-feature"}},[_v("Remove tags feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#remove-tags-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Given below is the activity diagram of a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("RemoveTagsCommand")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"edit-tag-feature"}},[_v("Edit tag feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#edit-tag-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Given below is the activity diagram of a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditTagCommand")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"find-tag-feature"}},[_v("Find tag feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#find-tag-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Given below is the activity diagram of a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindCommand")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"switch-sort-feature"}},[_v("Switch sort feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#switch-sort-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Given below is the activity diagram of a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("SwitchSortCommand")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("HR recruiters who handle a high volume of applicants.")]),_v(" "),_c('li',[_v("Prefers desktop applications over web or mobile alternatives.")]),_v(" "),_c('li',[_v("Types quickly and favors keyboard shortcuts over mouse navigation.")]),_v(" "),_c('li',[_v("Prioritizes speed and efficiency in tracking and managing applicant details.")]),_v(" "),_c('li',[_v("Comfortable with command-line interfaces to some extent.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": RecruitTrackPro streamlines applicant tracking, ensures quick data retrieval, and reduces administrative workload, making recruitment management more efficient.")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("add a new candidate by specifying their name, phone, and email")]),_v(" "),_c('td',[_v("store their basic contact information in one place")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("delete a candidate")]),_v(" "),_c('td',[_v("remove entries for candidates who are no longer relevant")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("list all candidates")]),_v(" "),_c('td',[_v("have a quick overview of everyone in my current pipeline")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("insert tags such as candidate skills and experience in their profile (e.g., “Java Developer”, “University Graduate”)")]),_v(" "),_c('td',[_v("easily identify candidates who meet the required skills or experience for a role")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("exit the application via a command")]),_v(" "),_c('td',[_v("cleanly close the program when I’m finished")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("store all application data locally")]),_v(" "),_c('td',[_v("access it even if I’m offline or between network connections")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("add free-form notes to a candidate’s record")]),_v(" "),_c('td',[_v("capture extra context or personal observations")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("update a candidate’s tags")]),_v(" "),_c('td',[_v("adjust how candidates are categorized over time")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("remove a candidate’s tags")]),_v(" "),_c('td',[_v("adjust how candidates are categorized over time")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("edit a candidate’s details (e.g., phone, email, address)")]),_v(" "),_c('td',[_v("keep the record accurate when a candidate’s information changes")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("find a candidate by name")]),_v(" "),_c('td',[_v("locate a specific candidate’s details quickly")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("sort the candidate list by name")]),_v(" "),_c('td',[_v("see them in alphabetical order for easier browsing")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("find candidates by other fields (e.g., phone, email)")]),_v(" "),_c('td',[_v("organize the data in the most useful way for my tasks")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("find candidates with a set of specific fields (e.g., phone, email)")]),_v(" "),_c('td',[_v("organize the data in the most useful way for my tasks")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("filter for candidates by specific skills (i.e. tags)")]),_v(" "),_c('td',[_v("find the most qualified applicants for a role")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("update the (optional) reference contact info for each candidate")]),_v(" "),_c('td',[_v("have all necessary details for thorough background checks")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("attach or link a candidate’s resume in their profile")]),_v(" "),_c('td',[_v("access their CV directly from the application")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("count the number of times I’ve contacted a candidate")]),_v(" "),_c('td',[_v("keep track of communication attempts without spamming them")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("create new tag categories (e.g., “Willing to Relocate”)")]),_v(" "),_c('td',[_v("capture additional attributes beyond standard fields")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("mark specific candidates as “High Priority”")]),_v(" "),_c('td',[_v("focus on them first for interviews or offers")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("view my command history")]),_v(" "),_c('td',[_v("reuse previous commands or correct mistakes")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("undo my last command")]),_v(" "),_c('td',[_v("revert an accidental action (e.g., deleting the wrong candidate)")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("redo a command I just undid")]),_v(" "),_c('td',[_v("restore changes if I reverted them by mistake")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("New User")]),_v(" "),_c('td',[_v("access a help command")]),_v(" "),_c('td',[_v("quickly learn the available features and syntax")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("create a new job posting (e.g., role title, required skills)")]),_v(" "),_c('td',[_v("track open positions within my organization")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("list all active job openings")]),_v(" "),_c('td',[_v("quickly see every position that needs to be filled")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("archive a job posting once it’s filled or no longer needed")]),_v(" "),_c('td',[_v("keep historical records without cluttering the active list")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("assign a candidate to a job posting")]),_v(" "),_c('td',[_v("track who is applying or being considered for each position")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("remove a candidate from a job posting")]),_v(" "),_c('td',[_v("correct mistakes or reassign them to a more suitable role")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("view assigned candidates under job postings")]),_v(" "),_c('td',[_v("see a focused list of all applicants for a specific position")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("view a list of unassigned candidates")]),_v(" "),_c('td',[_v("quickly identify who could be matched to newly opened roles")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("mark a job posting as “Urgent”")]),_v(" "),_c('td',[_v("prioritize filling it quickly")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("New User")]),_v(" "),_c('td',[_v("import candidate data from a CSV")]),_v(" "),_c('td',[_v("quickly populate the system using existing records")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("export candidate data to a CSV")]),_v(" "),_c('td',[_v("create backups or share the list with others")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("New User")]),_v(" "),_c('td',[_v("interact with sample data")]),_v(" "),_c('td',[_v("see how the app will look like in use")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("New User")]),_v(" "),_c('td',[_v("purge all current data")]),_v(" "),_c('td',[_v("delete sample data")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("RecruitTrackPro")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: UC-001 - Add Candidate")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests a list of all candidates.")])]),_v(" "),_c('li',[_c('p',[_v("RecruitTrackPro displays the list of candidates with relevant details.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to remove a specified candidate from the address book.")])]),_v(" "),_c('li',[_c('p',[_v("RecruitTrackPro updates the displayed list accordingly.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to search for candidates by a field and value.")])]),_v(" "),_c('li',[_c('p',[_v("RecruitTrackPro shows the list of matching candidates.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User did not enter a search field or value.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. RecruitTrackPro shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. User enters an invalid search field.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. RecruitTrackPro shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1c. User searches by phone number but enters an invalid phone number.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1c1. RecruitTrackPro shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1d. User searches by email but enters an invalid email address.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1d1. RecruitTrackPro shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1e. User searches by tag but enters an invalid tag.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1e1. RecruitTrackPro shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC-005 - Add Tag(s) to a Candidate")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Pre-Condition")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("The candidate must already exist in the system.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to delete a specific tag for a candidate.")])]),_v(" "),_c('li',[_c('p',[_v("RecruitTrackPro removes the specified tag from the candidate’s profile and shows a success message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User enters an invalid candidate index.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. RecruitTrackPro displays an error message: “The selected candidate does not exist. Please check the index and try again.”")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. User does not enter any tags.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. RecruitTrackPro displays an error message: “Tag name cannot be empty. Please enter a valid tag.”")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1c. User specifies a tag which does not exist the candidate's record.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1c1. RecruitTrackPro displays an error message: “Tag does not exist for this candidate. Please enter a valid tag.”")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should work without requiring an installer.")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 persons without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("Should not be dependent on a remote server.")]),_v(" "),_c('li',[_v("Should not use a Database Management System to store data.")]),_v(" "),_c('li',[_v("Data should be stored locally in a human editable text file.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("GUI should be "),_c('em',[_v("usable")]),_v(" for screen resolutions 1280x720 and higher.")]),_v(" "),_c('li',[_v("User Guide and Developer Guide should be PDF-friendly.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Usable")]),_v(": All functions can be used even if the user experience is not optimal")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Initial launch")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Download the jar file and copy into an empty folder.")])]),_v(" "),_c('li',[_c('p',[_v("Double-click the jar file."),_c('br'),_v("\nExpected: Shows the GUI with a set of sample candidates. The window size may not be optimum.")])])])]),_v(" "),_c('li',[_c('p',[_v("Saving window preferences")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Resize the window to an optimum size. Move the window to a different location. Close the window.")])]),_v(" "),_c('li',[_c('p',[_v("Re-launch the app by double-clicking the jar file."),_c('br'),_v("\nExpected: The most recent window size and location is retained.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"deleting-a-candidate"}},[_v("Deleting a candidate"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#deleting-a-candidate","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Deleting a candidate while all candidates are being shown")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: List all candidates using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple candidates in the list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 1")]),_c('br'),_v("\nExpected: First candidate is deleted from the list. Details of the deleted candidate shown in the result message.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 0")]),_c('br'),_v("\nExpected: No candidate is deleted. Error details shown in the result message.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect delete commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete x")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v(" (where x is larger than the list size)"),_c('br'),_v("\nExpected: Similar to previous.")])])])]),_v(" "),_c('li',[_c('p',[_v("Deleting a candidate while some candidates are being shown")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: Filter the list of candidates using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find")]),_v(" command. Multiple candidates in the list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 1")]),_c('br'),_v("\nExpected: First candidate is deleted from the list. Details of the deleted candidate shown in the result message.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 0")]),_c('br'),_v("\nExpected: No candidate is deleted. Error details shown in the result message.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect delete commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete x")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v(" (where x is larger than the list size)"),_c('br'),_v("\nExpected: Similar to previous.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"finding-a-candidate"}},[_v("Finding a candidate"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#finding-a-candidate","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Thu, 3 Apr 2025, 14:27:41 GMT+8]")])])])}
}];
