...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("sort the candidate list by name")]),_v(" "),_c('td',[_v("I can see them in alphabetical order for easier browsing")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("find candidates by other fields (e.g., phone, email)")]),_v(" "),_c('td',[_v("I can organize the data in the most useful way for my tasks")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("filter for candidates by specific skills (ie. tags)")]),_v(" "),_c('td',[_v("I can find the most qualified applicants for a role")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("update the (optional) reference contact info for each candidate")]),_v(" "),_c('td',[_v("I have all necessary details for thorough background checks")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("attach or link a candidate’s resume in their profile")]),_v(" "),_c('td',[_v("I can access their CV directly from the application")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("count the number of  times I’ve contacted a candidate")]),_v(" "),_c('td',[_v("I don’t spam them or lose track of communication attempts")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("create new tag categories (e.g., “Willing to Relocate”)")]),_v(" "),_c('td',[_v("I can capture additional attributes beyond standard fields")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("mark specific candidates as “High Priority”")]),_v(" "),_c('td',[_v("I can focus on them first for interviews or offers")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("view my command history")]),_v(" "),_c('td',[_v("I can reuse previous commands or correct mistakes")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("undo my last command")]),_v(" "),_c('td',[_v("I can revert an accidental action (e.g., deleting the wrong candidate)")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Recruiter")]),_v(" "),_c('td',[_v("redo a command I just undid")]),_v(" "),_c('td',[_v("I can restore changes if I reverted them by mistake")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("New User")]),_v(" "),_c('td',[_v("access a help command")]),_v(" "),_c('td',[_v("I can quickly learn the available features and syntax")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User did not enter a search field or value.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. RecruitTrackPro shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. User enters an invalid search field.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. RecruitTrackPro shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1c. User searches by phone number but enters an invalid phone number.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1c1. RecruitTrackPro shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1d. User searches by email but enters an invalid email address.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1d1. RecruitTrackPro shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a comment for a candidate.")])]),_v(" "),_c('li',[_c('p',[_v("RecruitTrackPro updates the candidate’s information.")])]),_v(" "),_c('li',[_c('p',[_v("RecruitTrackPro shows the list of candidates with the updated information")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. User gives an invalid index.\n"),_c('ul',[_c('li',[_c('p',[_v("1a1. RecruitTrackPro shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Fri, 7 Mar 2025, 0:59:48 GMT+8]")])])])}
}];
